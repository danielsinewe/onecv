...
- For LinkedIn import, prefer the Chrome connection in the Codex desktop task so the user can keep using their signed-in Chrome profile. Do not tell the user to reinstall a healthy Chrome plugin merely because a standalone CLI session cannot see it.
